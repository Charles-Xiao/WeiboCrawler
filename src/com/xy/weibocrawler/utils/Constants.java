...
public class Constants {
    ...
    private static final String[] FRUITS_ARR = {
            ...
            "番茄", "马铃薯", "洋葱", "蘑菇", "地沟油", "潲水油", "毒豆芽", "果汁", "土豆", "金针菇", "韭菜", "果脯", 
            "干果", "扁豆", "红富士", "竹笋", "荔枝", "草莓", "酱腌菜", "黄花菜", 
    };
    ...
    private static final String[] WINES_ARR = {
            "酒", "红酒", "白酒", "啤酒", "酒精", "黄酒", "米酒", "药酒", "果露酒", "果酒", "烧酒", "洋酒","葡萄酒", "奶酒", "青稞酒", "茅台"
    };
    ...
    private static final String[] MILKS_ARR = {
            ...
            "发酵乳", "乳酪", "乳饮料","奶制品", "蒙牛", "伊利", "皮革奶", "酸乳", "玉米奶", "乳钙", "牛乳"
    };
    ...
    private static final String[] SAFETY_ARR = {
            "食品", "安全", "过期", "变质", "超标", "色素", "健康", "有害", "有毒", "有利", "有损", "致癌", "标准", "监管", "掺假",
            "防腐剂", "质量", "问题","转基因", "注水", "食物中毒", "造假", "发霉", "劣质", "激素", "霉变", "胭脂红", "霉菌", "染色", "硫磺", "勾兑", "塑化剂", "污染",
            "假冒", "合格", "毒性", "伪劣", "异味", "细菌", "残留", "添加剂", "毒素"
    };
