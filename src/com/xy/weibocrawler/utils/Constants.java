...
public class Constants {
    ...
    private static final String[] FRUITS_ARR = {
            ...
            "番茄", "马铃薯", "洋葱", "蘑菇", "地沟油", "潲水油", "毒豆芽", "果汁", "土豆", "金针菇", "韭菜", "果脯", "干果",
            "扁豆", "红富士", "竹笋", "荔枝", "草莓", "酱腌菜", "黄花菜", "蛇果", "食用菌", "菌菇"
    };
    ...
    private static final String[] MILKS_ARR = {
            ...
            "发酵乳", "乳酪", "乳饮料", "奶制品", "蒙牛", "伊利", "皮革奶", "酸乳", "玉米奶", "乳钙", "牛乳", "灭菌奶"
    };
    ...
    private static final String[] SAFETY_ARR = {
            "食品", "安全", "过期", "变质", "超标", "色素", "健康", "有害", "有毒", "有利", "有损", "致癌", "标准", "监管",
            "掺假", "防腐剂", "质量", "问题", "转基因", "注水", "食物中毒", "造假", "发霉", "劣质", "激素", "霉变", "胭脂红",
            "霉菌", "染色", "硫磺", "勾兑", "塑化剂", "污染", "假冒", "合格", "毒性", "伪劣", "异味", "细菌", "残留", "添加剂",
            "毒素", "黑榜", "违禁", "检验", "抽检", "评审", "以次充好", "投诉", "风险", "致病", "达标", "保健", "改善", "功效", "保质期", "农药残留量", "投毒", 
            "兑水", "虚假"
    };
    ...
    private static final String[] URL_ARR = {
            ...
            "http://weibo.com/u/3276450133",
            "http://weibo.com/u/5359649889", 
            "http://weibo.com/u/1238994073",
            "http://weibo.com/guangzhoufda",
            "http://weibo.com/u/3870982729",
            "http://weibo.com/u/1281493412",
            "http://weibo.com/njfda",
            "http://weibo.com/uc274286783",
            "http://weibo.com/u/3701880892",
            "http://weibo.com/u/5128175397",
            "http://weibo.com/u/1335661387",
            "http://weibo.com/foodscienceweb",
            "http://weibo.com/u/3208088385",
            "http://weibo.com/u/3991843274",
            "http://weibo.com/whfda",
            "http://weibo.com/foodstd",
            "http://weibo.com/237588",
            "http://weibo.com/foodsafety365",
